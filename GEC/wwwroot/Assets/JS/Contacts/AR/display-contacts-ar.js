    ...
    $('#contact-dynamic-table')
        .DataTable({
            ...
            language: {
                ...
                zeroRecords: "لا يوجد مراسلون للعرض.",
                emptyTable: "لا يوجد أي مراسلون.",
                paginate: {
                    first: "الأول",
                    previous: "السابق",
                    next: "الموالي",
                ...
                <tr data-contact-id=${contactUtilities.getId(contact)}>
                    ...
                    <td class="contact-table-actions">
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="blue contact-details-button" data-contact-id="${contactUtilities.getId(contact)}" href="/Ar/Contacts/${contactUtilities.getId(contact)}">
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        <a href="/Ar/Contacts/${contactUtilities.getId(contact)}" class="tooltip-info contact-details-button" data-contact-id="${contactUtilities.getId(contact)}" data-rel="tooltip" title="التفاصيل">
                                            <span class="blue">
                                                <i class="ace-icon fas fa-search-plus bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-warning contact-edit-button" data-contact-id="${contactUtilities.getId(contact)}" data-rel="tooltip" title="تعديل">
                                            <span class="orange">
                                                <i class="ace-icon fas fa-edit bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-error contact-delete-button" data-contact-id="${contactUtilities.getId(contact)}" data-rel="tooltip" title="محو">
                                            <span class="red">
                                                <i class="ace-icon fas fa-trash-alt bigger-120"></i>
                                            </span>
                                        </a>
...
function contactsListItemTemplate(contacts) {
    ...
    if (contacts.length == 0) {
        item = `<p>لا يوجد مراسلون للعرض.</p>`;
    }
    else {
        for (let contact of contacts) {
            item += `
                    <div class="row contact-entry">
                        <div class="col-xs-12 col-sm-9">
                            <div class="contact-content contact-content-hidden-576">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>الطبيعة:&nbsp;</strong>${contactUtilities.getNature(contact)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>الصنف:&nbsp;</strong>${contactUtilities.getContactType(contact)}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>البريد الإلكتروني:&nbsp;</strong>${contactUtilities.getEmail(contact)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>رقم الهاتف:&nbsp;</strong>${contactUtilities.getTelephone(contact)}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>الفاكس:&nbsp;</strong>${contactUtilities.getFax(contact)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>العنوان:&nbsp;</strong>${contactUtilities.getAddress(contact)}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-action-buttons-hidden-576 text-center">
                                <a class="btn btn-white btn-primary btn-bold contact-details-button" data-contact-id="${contactUtilities.getId(contact)}" href="/Ar/Contacts/${contactUtilities.getId(contact)}">
