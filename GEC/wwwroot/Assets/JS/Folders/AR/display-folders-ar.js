    ...
    $('#folder-dynamic-table')
        .DataTable({
            ...
            language: {
                ...
                zeroRecords: "لا توجد ملفات للعرض.",
                emptyTable: "لا توجد أي ملفات.",
                paginate: {
                    first: "الأول",
                    previous: "السابق",
                    next: "الموالي",
                ...
                <tr data-folder-id=${folderUtilities.getId(folder)}>
                    ...
                    <td class="folder-table-actions">
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="blue folder-details-button" data-folder-id="${folderUtilities.getId(folder)}" href="/Ar/Folders/${folderUtilities.getId(folder)}">
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        <a href="/Ar/Folders/${folderUtilities.getId(folder)}" class="tooltip-info folder-details-button" data-folder-id="${folderUtilities.getId(folder)}" data-rel="tooltip" title="المراسلات">
                                            <span class="blue">
                                                <i class="ace-icon fas fa-search-plus bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-warning folder-edit-button" data-folder-id="${folderUtilities.getId(folder)}" data-rel="tooltip" title="تعديل">
                                            <span class="red">
                                                <i class="ace-icon fas fa-edit bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-error folder-delete-button" data-folder-id="${folderUtilities.getId(folder)}" data-rel="tooltip" title="محو">
                                            <span class="red">
                                                <i class="ace-icon fas fa-trash-alt bigger-120"></i>
                                            </span>
                                        </a>
                        ...
                        <div class="thumbnail search-thumbnail folder-entry">
                            ...
                            <div class="caption folder-caption">
                                ...
                                <div class="thumbnail-buttons">
                                    <a class="btn btn-white btn-primary btn-bold folder-details-button" data-folder-id="${folderUtilities.getId(folder)}" href="/Ar/Folders/${folderUtilities.getId(folder)}">
