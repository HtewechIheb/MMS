    ...
    $('#mail-dynamic-table')
        .DataTable({
            ...
            language: {
                ...
                zeroRecords: "لا توجد مراسلات للعرض.",
                emptyTable: "لا توجد أي مراسلات.",
                paginate: {
                    first: "الأول",
                    previous: "السابق",
                    next: "الموالي",
                ...
                <tr data-mail-id=${mailUtilities.getId(mail)}>
                    ...
                    <td class="mail-table-actions">
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="blue mail-details-button" data-mail-id="${mailUtilities.getId(mail)}" href="/Ar/Mails/${mailUtilities.getId(mail)}">
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        <a href="/Ar/Mails/${mailUtilities.getId(mail)}" class="tooltip-info mail-details-button" data-mail-id="${mailUtilities.getId(mail)}" data-rel="tooltip" title="التفاصيل">
                                            <span class="blue">
                                                <i class="ace-icon fas fa-search-plus bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-warning mail-edit-button" data-mail-id="${mailUtilities.getId(mail)}" data-rel="tooltip" title="تعديل">
                                            <span class="orange">
                                                <i class="ace-icon fas fa-edit bigger-120"></i>
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#" class="tooltip-error mail-delete-button" data-mail-id="${mailUtilities.getId(mail)}" data-rel="tooltip" title="محو">
                                            <span class="red">
                                                <i class="ace-icon fas fa-trash-alt bigger-120"></i>
                                            </span>
                                        </a>
...
function mailsListItemTemplate(mails) {
    var item = "";
    if (mails.length == 0) {
        item = `<p>لا توجد مراسلات للعرض.</p>`;
    }
    else {
        for (let mail of mails) {
            item += `
                    <div class="row mail-entry">
                        <div class="col-xs-12 col-sm-9">
                            ...
                            <h2 class="mail-header">${mailUtilities.getObject(mail)}</h2>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>المرسل:&nbsp;</strong>${mailUtilities.getSender(mail)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>الصنف:&nbsp;</strong>${mailUtilities.getMailType(mail)}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>المرسل إليه:&nbsp;</strong>${mailUtilities.getRecipient(mail)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>الوسيلة:&nbsp;</strong>${mailUtilities.getChannel(mail)}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <p><strong>له نسخة:&nbsp;</strong>${mailUtilities.getBoolean(mail.hasHardCopy)}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p><strong>تاريخ التسجيل:&nbsp;</strong>${mailUtilities.getDate(mail.registrationDate)}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mail-action-buttons-hidden-576 text-center">
                                <a class="btn btn-white btn-primary btn-bold mail-details-button" data-mail-id="${mailUtilities.getId(mail)}" href="/Ar/Mails/${mailUtilities.getId(mail)}">
                            ...
                            <div class="mail-action-buttons-shown-576 text-center">
                                <a class="btn btn-white btn-primary btn-bold mail-details-button" data-mail-id="${mailUtilities.getId(mail)}" href="/Ar/Mails/${mailUtilities.getId(mail)}">
                                    <i class="ace-icon fas fa-search-plus"></i>
                                    التفاصيل
                                </a>
...
function getAndRenderMails() {
    ...
    $.ajax({
        ...
        errorNotification('خطأ', "وقع خطأ أثناء تحميل المراسلات.", 3000);
