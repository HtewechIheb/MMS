...
{
    public class EditContactFrViewModel : IContactViewModel
    {
        ...
        [Required(ErrorMessage = "Le champ Nom est nécessaire."), MaxLength(50, ErrorMessage = "Le nom ne peut pas dépasser 50 caractères."), Remote("EditNameValidation", "ContactsAPI", AdditionalFields = "Id, WebsiteLanguage")]
