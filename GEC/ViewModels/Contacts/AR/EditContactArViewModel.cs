...
{
    public class EditContactArViewModel : IContactViewModel
    {
        ...
        [Required(ErrorMessage = "يجب ملء خانة الإسم."), MaxLength(50, ErrorMessage = "لا يمكن للإسم تجاوز 50 حرف."), Remote("EditNameValidation", "ContactsAPI", AdditionalFields = "Id, WebsiteLanguage")]
