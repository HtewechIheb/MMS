...
{
    public class EditMailArViewModel : IMailViewModel
    {
        ...
        [DataType(DataType.Date), EditMailArSendingDate]
        ...
        [Required(ErrorMessage = "يجب ملء خانة الموضوع."), MaxLength(24, ErrorMessage = "لا يمكن للموضوع تجاوز 255 حرف.")]
        public string Object { get; set; }
        public string Content { get; set; }
        public IFormFile DigitizedFile { get; set; }
        public Language? Language { get; set; }
        [MaxLength(24, ErrorMessage = "لا يمكن للكلمات الدالة تجاوز 100 حرف.")]
